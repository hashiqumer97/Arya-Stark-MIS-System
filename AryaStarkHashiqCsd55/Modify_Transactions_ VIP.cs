...
{
    public partial class frm_modifytransactionsvip : Form
    {
        public frm_modifytransactionsvip()
        {
            InitializeComponent();
        }
        ...
        {
            {
                try
                {
                    ...
                    tbl_transactionsTableAdapter1.UpdateQueryForTransactions(txt_nameoftransaction.Text, date, cbox_time.SelectedItem.ToString(), quantity, total, cbox_paymentmadein.SelectedItem.ToString(), cbox_methodofsending.SelectedItem.ToString(), handledby, transactionid);
