...
{
    public partial class frm_modifyclientvip : Form
    {
        public frm_modifyclientvip()
        {
            InitializeComponent();
        }
            ...
            { 
                try
                {
                    ...
                    else
                    {
                        ...
                        tbl_clientTableAdapter1.UpdateQueryForClient(txt_clientname.Text, txt_officeaddress.Text, mtxt_telno.Text, handledby, clientid);
        ...
        private void Modify_Clients_vip_Load(object sender, EventArgs e)
        {
            this.tbl_clientTableAdapter1.Fill(this.dataSet11.tbl_client);
        }
        ...
        private void frm_modifyclientvip_Load(object sender, EventArgs e)
        {
