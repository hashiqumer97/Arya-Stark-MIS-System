    ...
    public partial class frm_chart : Form
    {
        ...
        private void frm_chart_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dataSet11.tbl_stocks' table. You can move, or remove it, as needed.
                this.tbl_stocksTableAdapter.Fill(this.dataSet11.tbl_stocks);
            // TODO: This line of code loads data into the 'dataSet11.tbl_records' table. You can move, or remove it, as needed.
                 this.tbl_recordsTableAdapter.Fill(this.dataSet11.tbl_records);
