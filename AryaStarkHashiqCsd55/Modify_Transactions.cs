...
{
    public partial class frm_modifytransactionsadmin : Form
    {
        public frm_modifytransactionsadmin()
        {
            InitializeComponent();
        }
        ...
        private void frm_modifytransactions_Load(object sender, EventArgs e)
        {
