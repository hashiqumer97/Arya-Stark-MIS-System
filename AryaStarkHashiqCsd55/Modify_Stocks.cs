...
{
    public partial class frm_modifystocks : Form
    {
        public frm_modifystocks()
        {
            InitializeComponent();
        }
            ...
            { 
                try
                {
                    ...
                    else
                    {
                        ...
                        int.TryParse(cbox_clientid.Text, out clientid);
                        int stockid;
                        int.TryParse(txt_stockid.Text, out stockid);
                        tbl_stocksTableAdapter1.UpdateQueryForStocks(txt_productname.Text, date, txt_nameofsupplier.Text, clientid, stockid, perproductprice);
        ...
        private void btn_delete_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    int stockid;
                    int.TryParse(txt_stockid.Text, out stockid);
                    tbl_stocksTableAdapter1.DeleteQueryForStocks(stockid);
        ...
        private void frm_modifystocks_Load(object sender, EventArgs e)
        {
            ...
            this.tbl_stocksTableAdapter1.Fill(this.dataSet11.tbl_stocks);
